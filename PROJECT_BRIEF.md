...
This may eventually become a small Python library implementing that separation — but the architecture should emerge from actual experiments, not be designed in advance (see the Exploration Stage in section 11).
